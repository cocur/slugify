<?php
namespace Cocur\Slugify\Tests\Bridge\ZF3;

use Cocur\Slugify\Bridge\ZF3\SlugifyViewHelperFactory;
...
class SlugifyViewHelperFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @covers Cocur\Slugify\Bridge\ZF3\SlugifyViewHelperFactory::__invoke()
     */
    public function createService()
    {
        ...
        $this->assertInstanceOf('Cocur\Slugify\Bridge\ZF3\SlugifyViewHelper', $viewHelper);
    }
}
